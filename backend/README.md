...
## Project Structure
    ...
    ├── mithileshstudio_dev_76641  # Django project configurations
...
1. Clone this repo and `cd mithileshstudio_dev_76641`
...
2. Clone this repo and `cd mithileshstudio_dev_76641`
